 ...
 *   3. 定时任务示例:
 *        每天 10:00:05 抢 10 点场:  5 10 * * * node /ql/data/scripts/lucky_star_auto.js
 *        每天 15:00:05 抢 15 点场:  5 15 * * * node /ql/data/scripts/lucky_star_auto.js
 *
 * CLI 参数(优先级高于同名环境变量):
 *   --exchange <id>   兑换指定商品
