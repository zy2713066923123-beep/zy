...
const TOKEN_CACHE_FILE = path.join(__dirname, "mifengjingxishe_token_cache.json");
...
class Task {
    ...
    async getCheckinInfo() {
        ...
        $.log(`账号[${this.index}] 签到活动: checkinId=${this.checkinId || "未获取"} isShow=${this.isShow} showPage=${this.showPage}`);
        return data;
    }
