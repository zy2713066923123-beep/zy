...
class yyf():
  ...
  'referer': "https://servicewechat.com/wxafa302006eb257a6/5/page-frame.html",
  'accept-language': "zh-CN,zh;q=0.9"
}

    def signin(self):
        url = "https://lyz.api.5tan.com/api/signin/addSignIn"
        payload = {
        "platform": 1
        }
    ...
    def getmoney(self):
        url = "https://lyz.api.5tan.com/api/user/getRec"
    ...
    def cash(self,money=1):
        url = "https://lyz.api.5tan.com/api/logmoney/cash"
        payload = {
        "money": str(money),
        "platform": 1
        }
