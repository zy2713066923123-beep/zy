...
# ===================== 配置项 =====================
WECHAT_SERVER = (os.getenv("WX_SERVER") or os.getenv("YYB_SERVER") or os.getenv("WECHAT_SERVER") or os.getenv("YINGYONGBAO_SERVER") or os.getenv("YYB_SERVER") or "http://127.0.0.1:18273").strip().rstrip("/")
WXID_ENV = (
    os.getenv("WX_ID")
